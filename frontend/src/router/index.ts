...
const routes: RouteRecordRaw[] = [
  { path: '/', redirect: '/console/dashboard' },
  {
    ...
    children: [
      ...
      { path: 'groups', name: 'groups', component: () => import('@/views/PlaceholderView.vue'), meta: { title: '分组管理' } },
      ...
      { path: 'pricing', name: 'pricing', component: () => import('@/views/PlaceholderView.vue'), meta: { title: '模型定价' } },
